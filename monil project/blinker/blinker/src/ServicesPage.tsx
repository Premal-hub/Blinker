...
const services = [
  ...
  },
  {
    ...
    details: (
      <>
        ...
        <ul className="list-disc list-inside mt-2 text-gray-700">
          <li><strong>Scleral Lenses:</strong> Ideal for complex corneal conditions like keratoconus, post-LASIK ectasia, ocular surface disease, and severe dry eye.</li>
          <li><strong>PROSE Lenses:</strong> Advanced prosthetic devices designed for patients with extreme ocular surface irregularities or scarring.</li>
  ...
  },
  {
    ...
    icon: React.createElement(FaBrain, {
      className: "text-yellow-600 w-8 h-8 animate-pulse",
      "aria-hidden": "true",
    }),
    description:
      "We offer evidence-based vision therapy programs for children and adults with amblyopia, strabismus, or other binocular vision issues.",
    details: (
      <>
...
export default function Services() {
  return (
    <main className="p-10 bg-gray-50 min-h-screen">
      ...
      <section className="grid md:grid-cols-2 gap-10 max-w-6xl mx-auto" aria-label="Service cards">
