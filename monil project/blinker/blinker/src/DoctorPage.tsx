...
const Doctor: React.FC = () => {
  ...
  return (
    <>
        ...
        <section className="relative max-w-4xl w-full p-12 bg-white bg-opacity-30 backdrop-blur-lg rounded-3xl shadow-2xl border border-[#7a9f90] overflow-hidden">
          ...
          >
            ...
            <ul className="list-disc pl-8 space-y-3 text-[#4b5d44] text-lg font-medium">
              ...
              <li>Recognized by the Indian Medical Association for rural vision health camps</li>
            </ul>
          </motion.div>
          ...
          <div className="mt-12 flex justify-center relative z-20">
            <motion.button
              onClick={openModal}
              className="px-8 py-4 bg-gradient-to-r from-[#7a9f90] to-[#a2b9ae] text-white font-semibold rounded-full shadow-lg hover:scale-110 hover:shadow-[0_0_20px_#7a9f90] transition-transform duration-500"
              whileTap={{ scale: 0.95 }}
            >
              Book Consultation
            </motion.button>
      ...
      {/* Modal adjusted to screen scroll position */}
      <AnimatePresence>
        {modalOpen && (
          <motion.div
          ...
          >
            <motion.div
              ...
              style={{
                position: "absolute",
                top: scrollY + window.innerHeight / 2 - 200,
              }}
